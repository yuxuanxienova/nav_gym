...
export run_cmd="python3 /isaac_ws/nav_gym/nav_gym/nav_legged_gym/train/train_locomotion_mimic.py.py"
export custom_flags="--nv -B /cluster/home/$USER/git/nav_gym/:/isaac_ws/nav_gym"
