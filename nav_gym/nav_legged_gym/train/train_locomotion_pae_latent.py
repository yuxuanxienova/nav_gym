...
from nav_gym.nav_legged_gym.envs.locomotion_pae_latent_env import LocomotionPAELatentEnv
...
if __name__ == "__main__":
    log_dir = os.path.join(os.path.dirname(NAV_GYM_ROOT_DIR), "logs/locomotion_pae_latent/" + time.strftime("%Y%m%d-%H%M%S"))
    # checkpoint_dir = os.path.join(os.path.dirname(NAV_GYM_ROOT_DIR), "logs/locomotion_pae/20241209-173845/" + "model_300.pt")
    # log_dir = None
