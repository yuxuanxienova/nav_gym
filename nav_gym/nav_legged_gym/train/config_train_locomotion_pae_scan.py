from nav_gym.learning.modules.config.model_config import ArchitectureCfg, GaussianDistributionCfg,FLDLocomotionActorCriticCfg, PAELocomotionActorCriticCfg,PAEScanLocomotionActorCriticCfg
...
class TrainConfig:
    ...
    class actor_critic:
        ...
        actor_architecture = PAEScanLocomotionActorCriticCfg()
        critic_architecture = PAEScanLocomotionActorCriticCfg()
    ...
    class runner:
        ...
        num_steps_per_env = 36 #24 per iteration
