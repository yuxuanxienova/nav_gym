from nav_gym.learning.modules.config.model_config import TeacherArchCfg, betaActionDistCfg, betaActionDistCfg_pae_latent, GaussianDistributionCfg,LocalNavPAEScanResidualActorCriticCfg
...
class TrainConfig:
    ...
    class actor_critic:
        ...
        actor_architecture =LocalNavPAEScanResidualActorCriticCfg()
        critic_architecture =LocalNavPAEScanResidualActorCriticCfg()
