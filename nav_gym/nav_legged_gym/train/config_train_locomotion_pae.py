from nav_gym.learning.modules.config.model_config import ArchitectureCfg, GaussianDistributionCfg,FLDLocomotionActorCriticCfg, PAELocomotionActorCriticCfg
...
class TrainConfig:
    ...
    class actor_critic:
        ...
        actor_architecture = PAELocomotionActorCriticCfg()
        critic_architecture = PAELocomotionActorCriticCfg()
