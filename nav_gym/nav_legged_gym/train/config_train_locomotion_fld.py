from nav_gym.learning.modules.config.model_config import ArchitectureCfg, GaussianDistributionCfg,FLDLocomotionActorCriticCfg
...
class TrainConfig:
    ...
    class actor_critic:
        ...
        actor_architecture = FLDLocomotionActorCriticCfg()
        critic_architecture = FLDLocomotionActorCriticCfg()
