...
from nav_gym.nav_legged_gym.envs.modules.mimic_module import MimicModule
class LocomotionMimicEnv:
    robot: LeggedRobot
    cfg: LocomotionMimicEnvCfg
    """Environment for locomotion tasks using a legged robot."""
#-------- 1. Initialize the environment--------
    def __init__(self, cfg: LocomotionMimicEnvCfg):
        ...
        #10. Store the environment information from managers
...
#-------- 3. Step the environment--------
    ...
    def _post_physics_step(self):
        ...
        self.mimic_module.on_env_post_physics_step()
        #-----------------------------
        # rewards, resets, ...
        # -- rewards
