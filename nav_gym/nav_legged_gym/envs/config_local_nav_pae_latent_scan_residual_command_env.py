...
class LocalNavPAEEnvCfg:
    ...
    hl_decimation: int = 1#high level control loop: interval = hl_decimation * ll_env_cfg.dt (4 * 0.02 = 0.08[s])
    max_x_vel = 2.0
    max_y_vel = 1.0
    max_yaw_rate = 1.0
    ...
    class observations:
        ...
        class exte:
            ...
            velodyne_scan: dict = {"func": O.ray_cast, "noise": 0.1, "sensor": "velodyne_scanner"}
    ...
    class rewards:
        ...
        residual_actions = {"func": R.residual_actions, "scale": -0.2}

        goal_tracking_dense_dot = {"func": R.goal_tracking_dense_dot, "goal_radius": GOAL_RADIUS, "max_magnitude": 1.4, "scale": 15}
