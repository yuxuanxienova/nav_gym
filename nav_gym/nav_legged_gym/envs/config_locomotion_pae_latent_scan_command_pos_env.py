...
from nav_gym.nav_legged_gym.common.commands.commands_cfg import UnifromVelocityCommandCfg, WaypointCommandCfg, WaypointCommandCfg_LocomotionPAE
...
class LocomotionPAELatentScanEnvCfg:
    ...
    class observations:
        ...
        class prop:
            ...
            goal_position_commands: dict = {"func": O.goal_position_commands, "scale": 1.0}
    ...
    class rewards:
        ...
        # reward functions
        tracking_pos_ase: dict = {"func": R.tracking_pos_ase, "scale": 2.0, "exp_scale": 0.5}
        ...
        reward_tracking_reconstructed_projected_gravity = {"func": R.reward_tracking_reconstructed_projected_gravity, "scale": 0.3, "exp_scale": 3.0}
