from nav_gym.nav_legged_gym.envs.config_locomotion_pae_latent_scan_command_vel_env import LocomotionPAELatentScanEnvCfg as LocomotionEnvCfg
from nav_gym.nav_legged_gym.envs.locomotion_pae_latent_scan_command_vel_env import LocomotionPAELatentScanEnv as LocomotionEnv
...
if __name__ == "__main__":
    ...
    checkpoint_dir = os.path.join(os.path.dirname(NAV_GYM_ROOT_DIR), "logs/locomotion_pae_latent_scan_command_vel/cluster_1211_1/" + "model_8700.pt")
    # log_dir = None
    ...
    try:
        scripted_model_path = os.path.join(NAV_GYM_ROOT_DIR, "resources/model/low_level/locomotion_pae_latent_scan_command_vel/cluster_1211_1/" )
        file_name = "model_8700_jit_model.pt"
