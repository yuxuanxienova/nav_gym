...
# rsl-rl
from nav_gym.learning.algorithms.ppo_sp import PPO
...
class OnPolicyRunner:
    ...
    def learn(self, num_learning_iterations, init_at_random_ep_len=False):
        ...
        mean_value_loss, mean_surrogate_loss, mean_entropy_bonus = 0, 0, 0
        ...
        for it in range(start_iter, tot_iter):
            ...
            for i in range(self.num_steps_per_env):
                with torch.no_grad():
                    ...
                    #Store the transition in trajectory buffer, then clear the transition buffer
            ...
            self.trajectory_storage.add_trajectory(self.alg.storage)
